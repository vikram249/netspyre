...
if __name__ == "__main__":
    ...
    app.setWindowIcon(QtGui.QIcon('./images/icons/netspyrelogo.png'))
    ...
    try:    
        ...
        print("[-] The netspyre.qss file is missing. Your installation seems to be corrupted. Try downloading the latest version.")
        exit(0)
