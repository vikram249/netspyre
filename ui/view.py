...
class View(QObject):
    ...
    def __init__(self, ui, ui_mainwindow):
        ...
        self.startOnce()                                                # initialisations that happen only once, when the NETSPYRE is launched
...
#        self.settingsWidget.cancelButton.clicked.connect(self.cancelSettings)
    ...
    def openExistingProject(self):      
        if self.dealWithCurrentProject():
            filename = QFileDialog.getOpenFileName(self.ui.centralwidget, 'Open project', self.controller.getCWD(), filter='NETSPYRE project (*.sprt)')[0]
    ...
    def saveProjectAs(self):
        ...
        filename = QFileDialog.getSaveFileName(self.ui.centralwidget, 'Save project as', self.controller.getCWD(), filter='NETSPYRE project (*.sprt)', options=QFileDialog.DontConfirmOverwrite)[0]
        ...
        while not filename =='':
            ...
            filename = QFileDialog.getSaveFileName(self.ui.centralwidget, 'Save project as', '.', filter='NETSPYRE project (*.sprt)', options=QFileDialog.DontConfirmOverwrite)[0]
