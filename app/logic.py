...
class Logic():
    def __init__(self):    
        ...
        self.createTemporaryFiles()                                     # creates temporary files/folders used by NETSPYRE
    ...
    def createTemporaryFiles(self):
        try:
            ...
            tf = tempfile.NamedTemporaryFile(suffix=".sprt",prefix="netspyre-", delete=False)         # to store the database file
            self.outputfolder = tempfile.mkdtemp(suffix="-tool-output",prefix="netspyre-")            # to store tool output of finished processes
            self.runningfolder = tempfile.mkdtemp(suffix="-running",prefix="netspyre-")               # to store tool output of running processes
            ...
            self.usernamesWordlist = Wordlist(self.outputfolder + '/netspyre-usernames.txt')          # to store found usernames
            self.passwordsWordlist = Wordlist(self.outputfolder + '/netspyre-passwords.txt')          # to store found passwords
