...
def sanitise(string):                                                   # this function makes a string safe for use in sql query. the main point is to prevent netspyre from breaking, not so much SQLi as such.
    s = string.replace('\'', '\'\'')
    return s
